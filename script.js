...
if (document.title==="Autre Page (pour les 2)") {
  ...
  document.getElementsByTagName("body")[0].style.backgroundImage='linear-gradient(to left, transparent, rgb(144, 8, 83) 180%), url(./img/img_dan2-1.png)';
  /*document.getElementsByTagName("body")[0].style.backgroundImage  = "url(" + "./img/img_dan2-1.png" + ")";
